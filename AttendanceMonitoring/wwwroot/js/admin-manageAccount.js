...
$(document).ready(function () {
    ...
    $(document).on('submit', '#manageAccountForm', function (e) {
        ...
        $.ajax({
            url: '/Admin/ManageAccount/', //Dito no need ng userId kase meron nang hidden input sa form sa _manageaccount partial view
            //url: '/Admin/ManageAccount/' + userID, //// gumamit ng userID kapag may route parameter sa controller
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
